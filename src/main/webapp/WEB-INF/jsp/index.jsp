		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a class="nav-link"
					href="index.jsp"><b><strong>Home</strong> </b><span
						class="sr-only">(current)</span></a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<li class="nav-item"><a class="nav-link" href="#"
					data-toggle="modal" data-target="#exampleModal"><b><strong>Edit
								Profile</strong></b></a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<li class="nav-item"><a class="nav-link" href="#"
					data-toggle="modal" data-target="#exampleModal"><b><strong>Fund
	...
	<div class="row">
		<div class="col-md-5 m-5">
			<div class="card" align="left" style="width: 21rem;">
				<form:form class="p-4" action="login" method="post"
					modelAttribute="customer">
					<div class="form-group">
						<form:label path="customerId">Customer Id:</form:label>
						<form:input type="number" class="form-control"
							id="exampleDropdownFormEmail2" path="customerId"
					...
					<div class="form-group">
						...
						<form:input type="password" class="form-control"
							id="exampleDropdownFormPassword2" path="customerPassword"
